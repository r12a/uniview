...
function clearHighlighting () {
	...
	for (var i=0; i < nodeArray.length; i++) { 
		nodeArray[i].classList.remove('dim','c1-1','c2-0','c2-1','c3-0','c3-1','c3-2','c4-0','c4-1','c5-0','c5-1','c5-2','c6-0','c6-1','c6-2','c6-3','c7-0','c8-0','c9-0','c10-0','c11-0','c12-0','c13-0','c14-0','c15-0','c16-0','c17-0')
	    }
	}
...
function printProperties ( codepoint ) {
	...
	if (charType == IN_U_DB || charType == HAN_HANG_TANG || charType == PRIVATEUSE) { 
        ...
        out += `<tr><td class="padBlockStart padBlockEnd" colspan="2" style="font-weight:bold;"><a href="https://util.unicode.org/UnicodeJsps/character.jsp?a=${ cpHex }" target="cldr" style="font-size:110%;">More character properties</a></td></tr><tr>`
